...
try:
    ...
    print(
        "Warning: sentence-transformers not available. Using fallback embedding method."
    )
import anthropic
...
class ImageProcessor:
    ...
    def __init__(self):
        ...
        if not anthropic_key:
            print(
                "Warning: ANTHROPIC_API_KEY not set. Visual descriptions will be disabled."
            )
            ...
            message = self.anthropic_client.messages.create(
                ...
                messages=[{
                    ...
                    "content": [{
                        ...
                        "text",
                        "text":
                        """Describe this screenshot focusing on:
...
Keep the description concise but detailed enough for search purposes."""
    ...
    def _create_simple_embedding(self, text: str) -> List[float]:
        ...
        ui_keywords = [
            'button', 'btn', 'click', 'form', 'input', 'field', 'dialog',
            'modal', 'popup', 'error', 'warning', 'alert', 'menu',
            'navigation', 'nav', 'login', 'sign', 'auth', 'blue', 'red',
            'green', 'yellow', 'white', 'black', 'cancel', 'submit', 'save',
            'delete', 'edit', 'search', 'close', 'minimize', 'maximize',
            'window', 'tab', 'page', 'screen'
        ]
